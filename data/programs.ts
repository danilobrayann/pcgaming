...
export const PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    installCmd: { windows: 'winget install -e --id lencx.ChatGPT' },
  ...
  },
  {
    ...
    os: ['windows'],
    categories: ['utilities'],
    installCmd: { windows: 'winget install -e --id SoftDeluxe.FreeDownloadManager' },
    logo: 'https://cdn.simpleicons.org/download/00C853',
  },
  {
    id: 'antigravity',
    name: 'Antigravity (IA)',
    description: 'Seu assistente IA favorito desenvolvido pela Google Deepmind! 🚀',
    os: ['windows', 'linux'],
    categories: ['dev', 'utilities', 'productivity', 'gamer'],
    installCmd: { 
      windows: 'echo "O Antigravity já está integrado e trabalhando com você! 🤖❤️"',
      linux: 'echo "O Antigravity já está integrado e trabalhando com você! 🤖❤️"'
    },
